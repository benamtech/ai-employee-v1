...
| `docs/production-networking-and-dns.md` | Docs-only Part B design for Pod Alpha public DNS/TLS: Cloudflare DNS-only records, static `*.agents.amtechai.com`, Caddy wildcard DNS-01, IPv4-first with optional/deferred IPv6, webhook ingress vs egress default-deny, and firewall posture. |
