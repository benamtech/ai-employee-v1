...
Hermes context-engineering lives in `second-half-plan/context-engineering/`. **CE-1, CE-2, and CE-3 are
source-wired** (migrations `0029`/`0030` applied live); CE-4 is planned. The authoritative spec is
