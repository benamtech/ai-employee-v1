 ...
 */
import type { ApprovalRow, ReminderRow, StripeInvoiceRow, WorkEventRow } from "../surface-types";
...
export function DailyBrief({
  ...
  const nothing = approvals.length + upcoming + questions + paidCents === 0;
  ...
  return (
    <section style={{
      ...
      <div style={{ display: "flex", gap: tokens.space.xl, marginTop: tokens.space.lg, flexWrap: "wrap" }}>
        <Stat n={approvals.length} label="need approval" tone="accent" />
