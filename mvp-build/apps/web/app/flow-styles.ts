...
export const FLOW_CSS = `
  ...
  .fl-chat-step { padding-top: 24px; }
  .fl-thread { border: 1px solid rgba(10,10,10,0.10); min-height: 420px; max-height: 68vh; overflow: auto; padding: 12px; display: flex; flex-direction: column; gap: 9px; }
