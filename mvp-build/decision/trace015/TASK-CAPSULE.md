# Task capsule — TRACE015-GENERATED-BESPOKE-SOFTWARE-001

Base SHA: `ed0cd4b876149210193faa406aa7def41ba4f58e`  
Goal: Create a 64-dimensional generated-bespoke-software map for AMTECH: AI employees and swarms generate custom-feeling operating software for every computer-based job in non-technical businesses, without owners needing API keys or technical setup.

## Machine authority

- facts: `sha256:9b0b12ec689543aa95355cb45b1a6650c58e24e4a4957f02300f626383f6c306`
- authority DAG: `sha256:364a2571e87c96020d89b5f9e4f75e573712a0b9e5646596aaf7f62138587842`
- invariant hypergraph: `sha256:86b91b97da14228d9060bff5445be3ae3f94fdddf8efd9f55e1b1efb48a7db28`
- task diffusion: `sha256:05f63a01800e485440cb6171e0254872a47a0c1fb8b206bb588a92126e78d732`

## Mandatory context

- `mvp-build/packages/shared/src/operating-system.ts` — 0.006970
- `mvp-build/docs/architecture/13a-complete-memory-handoff-catalog.md` — 0.006879
- `mvp-build/apps/manager/src/lib/employee-stream.ts` — 0.006876
- `mvp-build/apps/web/app/create-ai-employee/CreateClient.tsx` — 0.005920
- `mvp-build/packages/shared/src/employee-ui-presentation.ts` — 0.005645
- `mvp-build/apps/web/app/agent/[employeeId]/fixture-runtime.ts` — 0.005612
- `mvp-build/apps/web/app/agent/[employeeId]/AgentSurface.tsx` — 0.005603
- `mvp-build/apps/web/app/agent/[employeeId]/lib/surface-model.ts` — 0.005430
- `mvp-build/packages/shared/src/platform-admin-authority.ts` — 0.005232
- `mvp-build/infra/scripts/acceptance/target-host-two-employee-isolation.mjs` — 0.004740
- `wiki/MVP/codebase-reading-guide-3-hour.md` — 0.004679
- `mvp-build/apps/web/app/api/_lib/manager.ts` — 0.004319
- `mvp-build/packages/shared/src/approval-authority.ts` — 0.003967
- `mvp-build/apps/web/app/agent/[employeeId]/owner-stream-state.ts` — 0.003863
- `mvp-build/packages/shared/src/command-effect.ts` — 0.003800
- `mvp-build/apps/manager/src/lib/operating-surface.ts` — 0.003640
- `mvp-build/apps/web/app/create-ai-employee/BusinessIdentityControl.tsx` — 0.003612
- `mvp-build/apps/manager/src/lib/approval-authority.ts` — 0.003529
- `mvp-build/apps/web/app/agent/[employeeId]/LiveEmployeeOperatingShell.tsx` — 0.003414
- `mvp-build/packages/shared/src/tool-contracts.ts` — 0.003371
- `mvp-build/infra/scripts/acceptance/production-proof-lib.mjs` — 0.003354
- `mvp-build/CODEGRAPH.md` — 0.003194
- `mvp-build/infra/scripts/acceptance/effective-capability-live-proof.mjs` — 0.003093
- `mvp-build/apps/web/app/agent/[employeeId]/fixtures.ts` — 0.003059
- `mvp-build/decision/trace010/generate_inventory.mjs` — 0.003047
- `mvp-build/packages/profile-packages/website_estimator_conversation/scripts/generate_profile.py` — 0.003026
- `mvp-build/infra/scripts/prod-like-normal-employee-up.mjs` — 0.002938
- `mvp-build/apps/manager/src/lib/provisioning-reconciler.ts` — 0.002818
- `mvp-build/scripts/generate-ws02-capability-manifold.mjs` — 0.002782
- `mvp-build/apps/manager/src/lib/platform-admin-runtime.ts` — 0.002717
...
- order 1: 1280 typed relations
- order 2: 4364 typed relations
- order 3: 10913 typed relations
- order 4: 3435 typed relations
