# Task capsule — TRACE017-PRODUCTION-STATE-DOCS-001

Base SHA: `c83c23be7d9bc5c36c164579ff47c16c45bb97a0`  
Goal: Update authoritative production state documentation after exact-HEAD c83c23b production bring-up, database status verification, deploy smoke proof, and production readiness boundary review, while marking UI Lab non-authoritative for the next redesign branch.

## Machine authority

- facts: `sha256:3a49c3d881c13a86e95fc21fbb5e5282a5bae61e8ea6365f802d4c30e93daad5`
- authority DAG: `sha256:6af2edce8577985513b1da0feccfd7f90b010a411010ca8a84563f892e2456e8`
- invariant hypergraph: `sha256:1f9fe84008978b2e2a24598344c46a12e12cfaa7a9f154c1c578d12d04c2a647`
- task diffusion: `sha256:399f0438c27d632efaf8f5993837a762a128f97552f2d6555deaa1eebce3d798`

## Mandatory context

- `mvp-build/docs/architecture/13a-complete-memory-handoff-catalog.md` — 0.008736
- `mvp-build/apps/manager/src/provisioner-host.ts` — 0.007169
- `mvp-build/infra/scripts/local/profile-generator-harness.mjs` — 0.006317
- `mvp-build/infra/scripts/acceptance/target-host-two-employee-isolation.mjs` — 0.005985
- `mvp-build/infra/scripts/acceptance/production-proof-lib.mjs` — 0.005540
- `mvp-build/apps/manager/src/lib/hermes-client.ts` — 0.005267
- `wiki/MVP/codebase-reading-guide-3-hour.md` — 0.005257
- `mvp-build/infra/scripts/local/acceptance/_lib.mjs` — 0.004769
- `mvp-build/CODEGRAPH.md` — 0.004534
- `mvp-build/infra/scripts/acceptance/effective-capability-live-proof.mjs` — 0.004242
- `mvp-build/apps/web/app/agent/[employeeId]/fixture-runtime.ts` — 0.004125
- `mvp-build/infra/scripts/acceptance/_env.mjs` — 0.004103
- `mvp-build/packages/shared/src/ui-lab-preset.ts` — 0.003950
- `mvp-build/packages/shared/src/adaptive-connector-runtime.ts` — 0.003594
- `mvp-build/infra/scripts/prod-env-proof.mjs` — 0.003434
- `mvp-build/scripts/ui-lab-registry.mjs` — 0.003275
- `mvp-build/packages/shared/src/command-effect.ts` — 0.003152
- `mvp-build/apps/manager/src/lib/platform-admin-runtime.ts` — 0.003071
- `mvp-build/apps/manager/src/lib/hermes-live-turn.ts` — 0.002944
- `scripts/local-prod/lib.mjs` — 0.002939
- `mvp-build/apps/manager/src/lib/provisioning-state-machine.ts` — 0.002883
- `mvp-build/second-half-plan/2026-07-20-capability-production-closure/02-production-next-step-plan.md` — 0.002730
- `mvp-build/apps/manager/src/lib/provisioning-reconciler.ts` — 0.002510
- `mvp-build/infra/scripts/deploy-smoke.mjs` — 0.002463
- `mvp-build/apps/web/app/agent/[employeeId]/lib/surface-model.ts` — 0.002360
- `mvp-build/apps/web/app/ui-lab/[scenario]/UiLabWorkbenchClient.tsx` — 0.002333
- `mvp-build/STANDARD.md` — 0.002129
- `mvp-build/memory/MEMORY.md` — 0.002114
- `mvp-build/apps/manager/src/lib/employee-stream.ts` — 0.002101
- `mvp-build/infra/scripts/platform-admin-session.mjs` — 0.002092
...
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/deploy-smoke.mjs:2ff586095863`
...
- order 1: 1677 typed relations
- order 2: 5503 typed relations
- order 3: 10136 typed relations
- order 4: 2676 typed relations
