# Task capsule - TRACE020-UI-LAB-PHASE2-GENERATED-RUNTIME

Base SHA: `e5e36c5072c69dcc57ccefce1a5d807f71f70058`  
Goal: Govern the UI Lab generated experience runtime so approved variants receive a capability-scoped projection of EmployeeExperienceModelV1 and a typed bounded intent bridge, while lab-only and experimental variants are refused live employee data, without replacing ResourcePayload or adding Manager authority.

## Machine authority

- facts: `sha256:02af26f4575453d724a5d2d226f1271ce24bc817237e257fdceff23f3e2dbd94`
- authority DAG: `sha256:63ccc95a7b58db40649d72c37b2d772116f6dec9e4bbf08c77bb7747071d4cc5`
- invariant hypergraph: `sha256:1a828eded8d29e25095fed1829fd5f225da5cbaa4405a54e1ec496d2dc596251`
- task diffusion: `sha256:aa52283086609f39d0b635f02d3d5d0752012cdb0e92f6c199b88f3958d4611a`

## Mandatory context

- `wiki/MVP/codebase-reading-guide-3-hour.md` - 0.006614
- `mvp-build/apps/web/app/agent/[employeeId]/fixture-runtime.ts` - 0.005554
- `mvp-build/packages/shared/src/ui-lab-preset.ts` - 0.005533
- `mvp-build/apps/manager/src/lib/hermes-client.ts` - 0.005154
- `mvp-build/docs/architecture/13a-complete-memory-handoff-catalog.md` - 0.004939
- `mvp-build/packages/shared/src/tool-contracts.ts` - 0.004562
- `mvp-build/apps/manager/src/lib/employee-stream.ts` - 0.004436
- `mvp-build/apps/manager/src/lib/hermes-live-turn.ts` - 0.003975
- `mvp-build/packages/shared/src/employee-ui-presentation.ts` - 0.003971
- `mvp-build/apps/manager/src/lib/provisioning-reconciler.ts` - 0.003628
- `mvp-build/packages/shared/src/adaptive-connector-runtime.ts` - 0.003488
- `mvp-build/scripts/ui-variant.mjs` - 0.003465
- `mvp-build/packages/shared/src/index.ts` - 0.003384
- `mvp-build/apps/web/app/_components/live-employee/UiLabShell.tsx` - 0.003167
- `mvp-build/infra/scripts/acceptance/target-host-two-employee-isolation.mjs` - 0.003164
- `mvp-build/packages/shared/src/command-effect.ts` - 0.003045
- `mvp-build/apps/manager/src/server.ts` - 0.003043
- `mvp-build/apps/manager/src/lib/connector-custody.ts` - 0.002906
- `mvp-build/packages/shared/src/ui-variant.ts` - 0.002764
- `mvp-build/apps/manager/src/provisioner-host.ts` - 0.002746
- `mvp-build/CODEGRAPH.md` - 0.002684
- `mvp-build/packages/shared/src/approval-authority.ts` - 0.002683
- `mvp-build/packages/shared/src/relationship-contract.ts` - 0.002638
- `mvp-build/apps/web/app/agent/[employeeId]/AgentSurface.tsx` - 0.002625
- `mvp-build/apps/manager/src/lib/approval-authority.ts` - 0.002457
- `mvp-build/packages/shared/src/resource-payload.ts` - 0.002354
- `mvp-build/infra/scripts/acceptance/production-proof-lib.mjs` - 0.002343
- `mvp-build/infra/scripts/acceptance/effective-capability-live-proof.mjs` - 0.002290
- `mvp-build/apps/manager/src/lib/profile-renderer.ts` - 0.002270
- `mvp-build/scripts/ui-lab-registry.mjs` - 0.002202
...
- `hyperedge:authority-obligation:file:mvp-build/authority-map.json:17da23e0261c`
- `hyperedge:authority-obligation:file:mvp-build/CODEGRAPH.md:fdc4a6e4d530`
- `hyperedge:authority-obligation:file:mvp-build/decision/active.json:75fdded1162e`
- `hyperedge:authority-obligation:file:mvp-build/decision/engine/repoctl.mjs:f0002fb925e0`
...
- `hyperedge:authority-obligation:file:mvp-build/decision/SESSION_ONBOARDING.md:5309d2aa7996`
- `hyperedge:authority-obligation:file:mvp-build/GAPS.md:ee2797c85105`
- `hyperedge:authority-obligation:file:mvp-build/memory/2026-07-23-production-state-after-c83c23b.md:ee461432557f`
- `hyperedge:authority-obligation:file:mvp-build/memory/MEMORY.md:90b42a7462c9`
...
- `hyperedge:authority-obligation:file:mvp-build/STANDARD.md:971bd3281e12`
- `hyperedge:authority-routing:authority-map:cb20a1b750c0`
- `hyperedge:behavioral-obligation:file:mvp-build/apps/manager/src/server.ts:2dfdbbd71c62`
...
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/acceptance/effective-capability-live-proof.mjs:79f362e63e32`
...
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/acceptance/target-host-two-employee-isolation.mjs:1e8cf32c4632`
...
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/deploy-smoke.mjs:034761849539`
...
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/local/profile-generator-harness.mjs:cad4e77e75ab`
...
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/platform-admin-session.mjs:3ca5383343aa`
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/prod-env-overlay.mjs:4c42b348baab`
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/prod-env-proof.mjs:3c106dddb4a1`
...
- `hyperedge:behavioral-obligation:file:mvp-build/infra/scripts/ui/product-shell-browser.mjs:4f56522814f9`
...
- `hyperedge:behavioral-obligation:file:mvp-build/scripts/ui-lab-registry.mjs:716714c116ea`
...
- order 1: 2221 typed relations
- order 2: 6313 typed relations
- order 3: 9370 typed relations
- order 4: 2088 typed relations
