...
|---|---|---|---|
| Identity and assignment | users, principals, memberships, assignments, grants, policies | migrations `0039`, `0053`, `0064`–`0069`; `owner-assignment-authority.ts` | [VERIFIED] |
...
| Employee runtime | one rendered profile/workspace and Hermes container per employee | `profile-renderer.ts`; launcher; `hermes-client.ts` | [VERIFIED] source |
