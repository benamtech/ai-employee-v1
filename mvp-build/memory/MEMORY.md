...
**Current branch note (2026-07-18):** the active integration branch is `employee-production-tuesday`, based on `research`, with draft PR `#23`; `main` is not the integration shortcut. The branch now contains the Lane 1 relationship/authorization foundation, Lane 3 durable command/effect kernel, S5 connector custody, S6 commercial attribution, S7 approval authority, source-wired S8 platform-admin authority, S9 authority-version revocation, assignment-bound owner/signed-resource enforcement, C3 owner-turn ambiguity repair, generated Manager routing, local-production/SDRT tooling, and the repaired Manager production-image lifecycle. Implementation SHA `a9184be1af68ed6c5372d642928db46b51eb0506` passed Phase 2 plan integrity (`29662757178`), Lane 1 (`29662757194`), S2/S7/S9 (`29662757252`), Lane 10 integrated CI/release evidence (`29662757197`), and Employee Work Production Boundary including the Manager image (`29662757204`). This is branch-level source/CI/blank-PostgreSQL/image evidence only. No real-Supabase, live-runtime, provider, fixture-free browser/SMS, commercial-reconciliation, capacity, rollback, deployment, or production acceptance is claimed.

## Index — newest first

- [2026-07-18 — S2–S9 authority and runtime-boundary checkpoint](2026-07-18-s2-s9-authority-runtime-checkpoint.md) — Canonical current branch handoff. Records owner assignment enforcement, C3 owner-turn repair, S5 connector custody, S6 commercial attribution, S7 approvals, source-wired S8 platform authority, S9 authority-version revocation, signed-resource closure, generated Manager routing, local-production/SDRT tooling, Docker lifecycle repair, exact implementation SHA, and current evidence boundary.
- [2026-07-18 — CI-green production plan digest](2026-07-18-ci-green-plan-digest.md) — Historical predecessor that records the earlier Lane 1/Lane 3/Lane 10 checkpoint and 16-step path. Superseded for current implementation state by the S2–S9 checkpoint.
- [2026-07-18 — Lane 1 scope inventory and Lane 10 evidence spine](2026-07-18-lane1-scope-lane10-evidence-spine.md) — Source-wired the consequential-surface scope registry, migration `0042`, assignment-scope tests, release-evidence schemas, release-evidence generator, and integrated Lane 10 CI workflow. Historical predecessor.
...
- [2026-07-18 — Standard remediation checkpoint: Lane 1 integrated, Lane 3 contract/red boundary](2026-07-18-standard-remediation-lane1-lane3-handoff.md) — Historical predecessor to the current handoff.
- [2026-07-18 — AMTECH Phase 2 Standard Enforcement Audit](2026-07-18-amtech-phase-2-standard-enforcement-audit.md) — Enforced the approved standard, created `GAPS.md` and `REMEDIATION.md`, and identified missing assignment, authority, custody, payer, beneficiary, and labor-attribution foundations. Evidence-only audit.
...
- [2026-07-17 — WS1/WS2 documentation reconciliation and website frontier](2026-07-17-ws1-ws2-doc-reconciliation-and-website-frontier.md) — Mixed historical product/documentation handoff. Hyper Site material moved to `benamtech/hyper-site` and is not current authority here.
