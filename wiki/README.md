...
2. **The offer** - the Estimate skill is the first proof object, but the first touch is now the **free public estimator funnel**: no signup, one real job, chat-native intake, estimate draft, feedback, then tuned package or Employee. See [`gtm/free-estimator-funnel.md`](gtm/free-estimator-funnel.md), [`offers/wedge-offers.md`](offers/wedge-offers.md), and [`offers/estimator-whole-product.md`](offers/estimator-whole-product.md).
...
- [`gtm/free-estimator-funnel.md`](gtm/free-estimator-funnel.md) - ⭐ primary contractor wedge: no-signup public AI estimator, cold email subject "We give contractors free estimates.", SEO tool-page strategy, and ladder into tuned package / live Employee - `active`
