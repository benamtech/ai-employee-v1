...
- [`MVP/ai-native-work-surface-research.md`](MVP/ai-native-work-surface-research.md) - ⭐ research spine for the next Work Surface: Engelbart/Licklider/Xerox Star/Malone/Suchman/Winograd translated into AMTECH's chat-native business operating surface — chat as command language, work objects as generated apps, approvals as OS permissions, and proof as trust - `active`
