...
> Sell first to **owner-operated residential painting & landscaping/hardscaping contractors**. Lead with a no-signup public estimator — **"We give contractors free estimates."** — where a contractor brings one real job, talks to an AMTECH AI employee, receives a line-item estimate draft, and then ladders into: **free estimator → free AI Employee trial → managed office loop.** The "fine tuning" moment is not a separate paid product; it is the contractor starting a trial employee that remembers their pricing, format, logo/template, job context, and follow-up rules. The owner surface should feel like Avery at work — Tell Avery, Needs your say, quiet Watching, exact approvals, and proof — not a chatbot beside dashboards. The **current forward build plan** is [`../mvp-build/second-half-plan/`](../mvp-build/second-half-plan/) (its product surfaces are `source-wired` and the production orchestration substrate is now proven on a real Docker host; the remaining gap is the real-VPS run + live provider proof — see [`MVP/second-half-current-and-future-state.md`](MVP/second-half-current-and-future-state.md), [`../mvp-build/docs/state-of-progress-2026-07-14.md`](../mvp-build/docs/state-of-progress-2026-07-14.md), and the master UX system at [`../mvp-build/docs/ux/`](../mvp-build/docs/ux/)). The original whole-product packet is [`MVP/old-build-plan/`](MVP/old-build-plan/), and the current implementation is [`../mvp-build/`](../mvp-build/). Bookkeepers are sequenced beachhead #2 on the same platform. **Note on "phases":** phase numbers appear across several distinct plans in this wiki (the second-half plan 0–6, the earlier reconciled technical plan `MVP/build-plan-current/` 0–13, the original workstreams, and the event-spine 3/3A/4). They are **not** a single sequence — always read a phase number against the plan it belongs to.
...
2. **The offer** - the Estimate skill is the first proof object, but the first touch is now the **free public estimator funnel**: no signup, one real job, chat-native intake, estimate draft, feedback, then a free AI Employee trial if they want the estimator to remember their business. See [`gtm/free-estimator-funnel.md`](gtm/free-estimator-funnel.md), [`offers/wedge-offers.md`](offers/wedge-offers.md), and [`offers/estimator-whole-product.md`](offers/estimator-whole-product.md).
3. **How to reach them** - outbound, SEO, referrals, and local follow-up now point to the free estimator first; phone remains useful for no-website rows and high-intent follow-up, but it is no longer the primary wedge. See [`gtm/outbound-system.md`](gtm/outbound-system.md), [`gtm/outreach-engine.md`](gtm/outreach-engine.md), and [`00-decision.md`](00-decision.md) §11–13.
4. **How content compounds** - volume-first articles should become graph nodes and utility surfaces: articles, schema, OKF/concepts, images, Pinterest, social answers, and **public estimator/calculator tools** that perform the task directly. See [`gtm/agentic-article-research-system.md`](gtm/agentic-article-research-system.md).
5. **How it's built & scaled** - the Work Surface and deliverable-type system are the Macintosh/operating-surface layer for AI agents: chat is the command language, work objects are generated task surfaces, approvals are business permissions, and proof is part of the interface. See [`MVP/ai-native-work-surface-research.md`](MVP/ai-native-work-surface-research.md), [`MVP/old-build-plan/15-interaction-reimagined-the-work-surface.md`](MVP/old-build-plan/15-interaction-reimagined-the-work-surface.md), [`principle-deliverable-driven-surfaces.md`](principle-deliverable-driven-surfaces.md), and [`strategy-4-year-implications.md`](strategy-4-year-implications.md).
...
- [`MVP/second-half-current-and-future-state.md`](MVP/second-half-current-and-future-state.md) - ⭐ **current build state (2026-07-14)**: the second-half plan's product surfaces (Avery-first owner UI, SMS ambient inbox + signed Review, tool-agnostic Connector Center, resurfacing, materialization/capability layer, MCP-UI, Gmail/Stripe/**QuickBooks** connectors, operator admin, and context-engineering substrate) are all `source-wired`, and the production orchestration substrate (docker-compose core + employee lifecycle + Docker-DNS/Caddy routing) is now **proven on a real Docker host**; the remaining gap is the **real-VPS run** (reboot recovery, durability/observability, egress apply, capacity) plus **live provider proof** (incl. the LLM tool loop). Companion to [`../mvp-build/second-half-plan/`](../mvp-build/second-half-plan/), [`../mvp-build/docs/state-of-progress-2026-07-14.md`](../mvp-build/docs/state-of-progress-2026-07-14.md), the deploy-readiness review, and the re-sequenced roadmap - `active`
- [`../mvp-build/docs/ux/`](../mvp-build/docs/ux/) - ⭐ master UX system for AMTECH UI work: Aqua HIG translation, current UX map, research ledger, implementation coverage audit, generative UI frontier, fixture/production policy, and post-release UI roadmap - `active`
...
- [`MVP/ai-native-work-surface-research.md`](MVP/ai-native-work-surface-research.md) - ⭐ research spine behind the current Avery-first owner UI: Tell Avery as command language, work objects as generated apps, approvals as exact permission moments, and proof as trust - `active`
...
- [`gtm/free-estimator-funnel.md`](gtm/free-estimator-funnel.md) - ⭐ primary contractor wedge: no-signup public AI estimator, cold email subject "We give contractors free estimates.", SEO tool-page strategy, and ladder into a free AI Employee trial - `active`
...
- [`gtm/outreach-engine.md`](gtm/outreach-engine.md) - contractor free-estimator-first tactical detail (scripts, cadence, benchmarks) under the system - `complete`
...
- [`offers/wedge-offers.md`](offers/wedge-offers.md) - the free-estimator → free-trial-Employee → paid managed-office-loop ladder, connector tiers, line-item rule - `complete`
