# Free Public Estimator Funnel

**Status: active** · _Created 2026-07-14. This is the primary contractor wedge: give contractors one real estimate for free through a public AI estimator, then ladder into the AI Employee._
...
```text
We give contractors free estimates.
```

Promise:

> Pick one job you need to estimate. On this page, talk to our AI employee the same way you would talk to your secretary, estimator, or office manager. Give it notes, photos, measurements, customer messages, pricing rules, your logo, or an existing estimate template if you have one. It will help turn the job into a clean estimate draft with line items, assumptions, and a downloadable file. No signup required. Just tell us what you think.

The point is not a free calculator. The point is to let a contractor feel the AMTECH employee doing one piece of real office work before a sales conversation starts.

## Funnel shape

```text
cold email / SEO tool page / referral
  -> no-signup contractor estimator page
  -> chat with public AMTECH estimator
...
## Why this is stronger than the old first touch
...
The public estimator page should:

- lead with the literal offer, not a generic AI headline;
- accept natural-language job notes;
- accept photos and files where the implementation supports it;
- ask for missing scope facts without turning into a long form;
- produce a line-item estimate draft with assumptions and confidence notes;
...
Use this as the canonical first email:
...
```text
Most estimate calculators ask homeowners to fill out a form. This one is for you: give it the messy job notes you already have and see if it can save you the write-up.
```

## SEO strategy

The article system should treat tools as first-class graph nodes:

- painting estimate generator;
- interior repaint cost estimator;
- landscaping estimate generator;
- hardscaping quote calculator;
- junk removal estimate generator;
- remodel scope-to-estimate helper;
- "turn job photos into an estimate" pages;
- city/trade-specific cost helper pages where useful and honest.

Each tool page should have:

- a useful interactive estimator;
- short supporting copy that explains inputs, assumptions, and limits;
...
## Ladder into the paid product

The free estimator creates natural upgrade moments:
...
- The free estimator can draft and download. It must not send to the contractor's customer.
- It should visibly label assumptions and low-confidence items.
- It should not present final-number authority as AMTECH's. The contractor owns the final price.
- It should not require signup for the first draft.
- It should avoid legal/contract/lien language unless explicitly scoped and reviewed.
- It should not expose internal AMTECH/Hermes terms.
